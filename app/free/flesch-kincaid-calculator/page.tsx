...
const AGENT_COMMAND = `Use the PromptRaise readability JSON endpoint to measure the readability of your text or content. Send a POST request to ${siteUrl}/json/readability with a JSON body {"text": "<the text to score>"}. It returns six readability scores (Flesch Reading Ease, Flesch-Kincaid Grade Level, Gunning Fog, SMOG, Coleman-Liau, ARI). No key or account needed.`;

const CURL_SNIPPET = `curl -s -X POST ${siteUrl}/json/readability \\
