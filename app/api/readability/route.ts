...
/**
 * JSON API for AI agents, scripts and any programmatic consumer of the
 * readability + citation analysis. POST { text } and get the same numbers the
 * calculator shows, without a browser.
 *
 *   curl -s -X POST https://promptraise.com/api/readability \
