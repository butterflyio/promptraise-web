  ...
  return (
    <>
      ...
      <div className="fixed inset-x-0 top-0 z-[60]">
        <div className="flex h-10 w-full items-center justify-center gap-3 border-b border-black/10 bg-white/70 px-4 text-center text-[13px] leading-none font-semibold text-black shadow-sm backdrop-blur-xl backdrop-saturate-150">
          <span className="min-w-0 truncate">{announcement.text}</span>
          {announcement.linkLabel && announcement.linkUrl ? (
            <a
              href={announcement.linkUrl}
              className="shrink-0 underline decoration-1 underline-offset-2 hover:opacity-70"
              target={
