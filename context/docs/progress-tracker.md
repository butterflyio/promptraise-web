...
- **Mobile burger menu - REAL root cause fixed (2026-08-24, commit 434e2fe on fix/mobile-comparison-figma, deployed to dev.promptraise.com):**
  ...
  - Verified in mobile viewport (390x844): drawer is now a direct child of body, rect x:0 y:0 390x844, opaque rgb(10,10,12), z-80, no hydration errors, no next-error. Ready for Zain eyeball on dev; then staging, then gated prod.
